...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    H_prime = 1 + (H + 2 * pad - filter_size) / stride / 2
    W_prime = 1 + (H + 2 * pad - filter_size) / stride / 2

    num_conv_params = F * H_prime * W_prime

    # hidden fc params
    self.params['W2'] = np.random.normal(0, weight_scale, (num_conv_params, hidden_dim))
